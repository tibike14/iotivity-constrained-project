...
{
  (void)data;
  oc_set_custom_device_property(purpose, "Room1_lamp1");
}
...
app_init(void)
{
  ...
  ret |= oc_add_device("/oic/lamp1", "oic.d.light", "Tibi's light", "1.0", "1.0",
                       set_device_custom_property, NULL);
	oc_new_string(&name, "Lamp1_room1", 11);	//This is what sent out as UniqueID of device?!
  return ret;
}
