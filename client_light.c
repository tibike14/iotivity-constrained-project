...
{
  (void)data;
  oc_set_custom_device_property(purpose, "LampController");
}
...
app_init(void)
{
  ...
  ret |= oc_add_device("/oic/lampcontroller", "oic.d.phone", "Lamp Controller", "1.0", "1.0",
...
observe_light(oc_client_response_t *data)
{
  ...
  while (rep != NULL) {
    ...
    rep = rep->next;	//if commented --> only get_temperature
  }
